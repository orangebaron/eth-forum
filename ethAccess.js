...
const addr = '0x8e60f2f24286b0dcdbf56b19ae7f29082307e381';
const abi = [
    {
	"constant": false,
	"inputs": [
...
forumContract.posts(880654, function(a,b) {console.log(b)});
...
function actOnReplyList(id,func) {
	getReplyList(id,function(a){getMoreInfo(a,function(a){getAliases(a, func)})}); //first element is the text, second the address of sender, third the parent address, and fourth is whether it's a forum 
}
