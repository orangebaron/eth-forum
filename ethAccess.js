window.onload = function () {
	...
	actOnReplyList(123,console.log);

	function makePost(id, text, replyingTo, isForum){
		forumContract.MakePost(id, text, replyingTo, isForum, {value: 0, gas: 200000}, function(err, result){console.log(result)});
	}

	makePost(666, "no you're not", 123, false);
}
